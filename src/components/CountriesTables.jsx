...
const CountriesTables = () =>{
    ...
    const [filterCountries, setFilteredCountires] = useState([]);
  ...
  const columns = [
    ...
    {
        name:"Action",
        cell: row=> <button className="btn btn-primary" onClick={()=> alert("Not Editable")}>Edit</button>
    }
  ]
